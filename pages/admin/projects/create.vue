...
<div>
    <NuxtLayout name="admin">
        ...
        <template #default>
            <div class="font-bold text-3xl flex gap-2">New Project</div>
...
const data_skills = ref<SkillCategory[]>([]);
const selected_skills = ref<Skill[]>([])
...
const save = async () => {
    ...
    try {
        ...
        await ProjectStore.create(postData, newPhoto, selected_skills.value)
