    ...
    <div>
        <NuxtLayout name="admin">
            ...
            <template #default>
                ...
                <div class="py-3">
                    ...
                    <div v-if="ProjectStore.projects.length"
                        ...
                        <div v-for="project in ProjectStore.projects"
                            ...
                            <div
                                class="hover:scale-105 duration-300 aspect-video bg-neutral/10 rounded-lg overflow-hidden relative flex justify-center items-center">
                                <img v-if="project.photos.length" :src="apiUrl + project.photos[0].path_md"
                                    :alt="project.title" class="max-w-full max-h-full">
                            ...
                            project.company }}</div>
                            <div class="truncate text-sm font-light text-wrap line-clamp-2">{{ project.description }}
                            </div>
                        </div>
                    </div>
                ...
                <!-- delete confirmation -->
                <AdminConfirmation action-text="Delete" :show="confirmDelete" @close="confirmDelete = false"
                    @yes="remove">
