...
<div class="aspect-video rounded-xl overflow-hidden hover:scale-105 duration-300 bg-accent/20">
    <img v-if="blog.photos.length" :src="apiUrl + blog.photos[0].path_md" alt="" class="object-cover h-full mx-auto">
