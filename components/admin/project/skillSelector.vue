        ...
        <div class="modal-box overflow-y-auto">
            ...
            <div>
                <div v-for="category in SkillStore.categories">
                    <label class="label-text font-semibold flex items-center gap-4 mt-2 mb-px">{{ category.title
                        }}</label>
                    <div class="flex flex-wrap gap-2">
                        <Skill :skill="skill" v-for="skill of category.skills"
                            class="bg-slate-500 cursor-pointer hover:scale-105"
                            @click="$emit('select', skill, category)"
